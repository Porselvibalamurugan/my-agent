...
export function ensureMemoryFile(memoryFilePath, logInfo) {
...
export function readMemoryContext(memoryFilePath, memoryMaxChars, logInfo) {
    try {
...
export function buildPromptWithMemory(params) {
    const { userPrompt, memoryFilePath, callbackHost, callbackPort, callbackChatStateFilePath, callbackAuthToken, memoryContext, conversationContext = '', contextQueueContent = '', messagingPlatform, includeSchedulerApi = true, } = params;
