...
<html lang="en">
  ...
  "razor": "/monacoeditorwork/html.worker.bundle.js"
    ...
    <title>ClawContainer — GitClaw in your browser</title>
    <link rel="icon" type="image/png" href="data:image/png;base64," />
    <script type="module" crossorigin src="/assets/index-BnBKg8GZ.js"></script>
    <link rel="stylesheet" crossorigin href="/assets/index-Dq3FlPWe.css">
  </head>
  <body>
    <!-- Loading overlay -->
    ...
    <div id="app">
      ...
      <header id="topbar">
        <div class="topbar-left">
          <span class="logo"><img src="/logo.png" alt="ClawContainer" width="20" height="20" class="topbar-logo" /> ClawContainer</span>
      ...
      <div id="bottom-bar"><img src="/logo.png" alt="" width="14" height="14" style="vertical-align:middle" /> <span class="bottom-bar-text">ClawContainer</span> <span class="bottom-bar-sep">|</span> <span class="bottom-bar-desc">A serverless container built for AI Agents — runs entirely in your browser using web container</span></div>
    </div>
